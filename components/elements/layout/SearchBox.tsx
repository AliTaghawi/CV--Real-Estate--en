...
const SearchBox = () => {
  ...
  return (
    <div className="relative">
      <div className={`hidden xs:flex items-center bg-white dark:bg-zinc-950 py-1 px-2.5 border border-zinc-300 dark:border-zinc-500 rounded-2xl`}>
        <input
          type="text"
          name="Search"
          className="outline-0"
      ...
      <button onClick={showHandler} className="xs:hidden text-xl p-1 hover:bg-zinc-200/65 dark:hover:bg-zinc-700 rounded-md transition-colors ease-in">
        <IoMdSearch/>
      </button>
