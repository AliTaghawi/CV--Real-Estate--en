  ...
  return (
    <div>
      {session.status === "authenticated" && (
        <Link
          href="/dashboard"
          className="flex items-center text-xl p-1 rounded-md text-cyan-700 dark:text-cyan-500 hover:bg-zinc-200/65 dark:hover:bg-zinc-700 transition-colors ease-in"
        >
          <FaRegUserCircle />
        </Link>
      )}
